...
/** A language-comment autogen header (default `//`), byte-compatible with
 *  secondsee/node-codegen's swiftAutogenHeader / kotlinAutogenHeader / tsAutogenHeader
 *  when by = "@ebowwa/node-codegen". */
